        ...
        <div class="container">
            <div class="row">
                <div class="col-md-10 col-lg-8 mx-auto">
                 ...
                 <h1 >Monva</h1>   <h3 class="text-warning">GET DIGITAL NEWS&PRODUCTS! <br> KNOW MORE... </h3></div>
                </div>
            </div>
     </div>
    </header>
                    ...
                    <div class="col-md-10 col-lg-12">
                        ...
                        <div class="post-preview">
                            <a href="post-details.php?id=<?php echo htmlentities($result->id); ?>">
                                <h2 class="post-title text-dark"><?php echo htmlentities($result->title); ?>,
                                    <i><?php echo htmlentities($result->catname); ?></i></h2>
                                <h3 class="post-subtitle text-primary"><?php echo htmlentities($result->grabber); ?></h3>
                            </a>
                             <p class="post-meta text-success">Posted by&nbsp;<?php echo htmlentities($result->username); ?>
