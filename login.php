                ...
                <div class="col-xl-10 col-lg-12 col-md-9">
                    ...
                    <div class="card o-hidden border-0 shadow-lg my-5">
                        <div class="card-body p-0">
                            ...
                            <div class="row">
                                <div class="col-lg-6 d-none d-lg-block" style="background-image: url(assets/img/post-bg.jpg);"></div>
                                <div class="col-lg-6">
                                    <div class="p-5">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <a href="admin/index.php"
                                               class="btn btn-warning btn-block text-black-50 btn-user ">ADMINISTRATOR</a>
                                        </div>
                                        <hr>
                                        <div class="text-center">
