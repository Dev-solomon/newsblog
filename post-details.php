...
<body>
    ...
    <header class="masthead"
            style="background-image:url('assets/img/images (1).jpg');">
        <?php } else { ?>
        <header class="masthead"
                style="background-image:url('assets/img/images (1).jpg');">
                <!-- postimages/<?php /*echo htmlentities($result->image1); */?>'); -->
            <?php } ?>
                ...
                <div class="row">
                    <div class="col-md-10 col-lg-8 mx-auto">
                        <div class="site-heading">
                            <h1>Monva</h1><span class="subheading">GET DIGITAL NEWS&PRODUCTS! <br> KNOW MORE... </span></div>
                    </div>
                </div>
            </div>
        </header>
